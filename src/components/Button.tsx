...
export const Button = ({ children, compact, slate }: ButtonProps): JSX.Element => {
  ...
  const style = `w-full ${height} ${background} rounded-md border border-zinc-300 shadow-md ${margin} text-md ${textColor} tracking-wider transition-all duration-75 active:border-slate-400 active:shadow-sm`;
