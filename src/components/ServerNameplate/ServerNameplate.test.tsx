...
it("renders LiveServer", () => {
  ...
  expect(
    container.querySelector(".server-nameplate__countdown--value").textContent
  ).toBe("01:00:00");
});
...
it("renders DormantServer", () => {
  ...
  expect(
    container.querySelector(".server-nameplate__players--value")
  ).toBeNull();
  expect(container.querySelector(".server-nameplate__queue--value")).toBeNull();
  expect(
    container.querySelector(".server-nameplate__countdown--value").textContent
  ).toBe(starts.diffNow().toFormat("hh:mm:ss"));
});
